namespace Loupedeck.GetPushNotificationsPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.GetPushNotificationsPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.GetPushNotificationsPlugin.Resources.Resource.txt`.
